...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    >;
    injuries: Schema.Attribute.Relation<'oneToMany', 'api::injury.injury'>;
    communications: Schema.Attribute.Relation<
      'manyToMany',
      'api::communication.communication'
    >;
    player_performances: Schema.Attribute.Relation<
      'oneToMany',
      'api::player-performance.player-performance'
    >;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiAttendanceAttendance extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    etat: Schema.Attribute.Enumeration<
      ['present', 'absence justifi\u00E9', 'absence', 'retard']
    >;
...
export interface ApiCommunicationCommunication
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<
      ['announcement', 'newsletter', 'event_notification']
    >;
...
export interface ApiCompetitionCompetition extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    name: Schema.Attribute.String;
    type: Schema.Attribute.Enumeration<
      ['local', 'regional', 'national', 'international', 'coupe']
    >;
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    location: Schema.Attribute.String;
    type: Schema.Attribute.Enumeration<
      ['training', 'match', 'tournament', 'other']
    >;
    ...
    performances: Schema.Attribute.Relation<
      ...
      'api::performance.performance'
    >;
    event_ratings: Schema.Attribute.Relation<
      'oneToMany',
      'api::event-rating.event-rating'
    >;
    player_performances: Schema.Attribute.Relation<
      'oneToMany',
      'api::player-performance.player-performance'
...
export interface ApiEventRatingEventRating extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<['player', 'coach']>;
    event: Schema.Attribute.Relation<'manyToOne', 'api::event.event'>;
    users: Schema.Attribute.Relation<
      'oneToMany',
      'plugin::users-permissions.user'
...
export interface ApiInjuryInjury extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    recoveryTime: Schema.Attribute.Integer;
    etat: Schema.Attribute.Enumeration<['active', 'recovering', 'resolved']>;
    treatmentPlan: Schema.Attribute.Blocks;
    user: Schema.Attribute.Relation<
      'manyToOne',
      'plugin::users-permissions.user'
    >;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::injury.injury'>;
  };
}
...
export interface ApiMatchMatch extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    playByPlay: Schema.Attribute.JSON;
    homeLineup: Schema.Attribute.JSON;
    awayLineup: Schema.Attribute.JSON;
    notes: Schema.Attribute.Blocks;
    ...
    match_result: Schema.Attribute.Relation<
      'oneToOne',
...
export interface ApiMatchResultMatchResult extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    homeTeamScore: Schema.Attribute.Integer;
    awayTeamScore: Schema.Attribute.Integer;
...
export interface ApiPlanPlan extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    name: Schema.Attribute.Enumeration<['Starter', 'Pro', 'Enterprise']>;
    price: Schema.Attribute.Decimal;
    memberLimit: Schema.Attribute.Integer;
...
export interface ApiPlayerPerformancePlayerPerformance
  extends Struct.CollectionTypeSchema {
...
export interface ApiSubscriptionSubscription
  ...
  attributes: {
    startDate: Schema.Attribute.DateTime;
    endDate: Schema.Attribute.DateTime;
    etat: Schema.Attribute.Enumeration<['active', 'expired', 'cancelled']>;
...
export interface ApiTaskTask extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    etat: Schema.Attribute.Enumeration<['pending', 'completed', 'overdue']>;
    type: Schema.Attribute.Enumeration<
      [
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::event-rating.event-rating': ApiEventRatingEventRating;
      'api::injury.injury': ApiInjuryInjury;
      'api::match.match': ApiMatchMatch;
      'api::match-result.match-result': ApiMatchResultMatchResult;
      'api::performance.performance': ApiPerformancePerformance;
      'api::plan.plan': ApiPlanPlan;
      'api::player-performance.player-performance': ApiPlayerPerformancePlayerPerformance;
